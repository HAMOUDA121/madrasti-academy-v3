...
# نستعمل نموذج User الافتراضي الخاص بـ Django مع ربطه بـ StudentProfile
"""
with open('accounts/models.py', 'w', encoding='utf-8') as f:
    f.write(models_py)

# 3. ملف Views للحسابات
...
# 5. تحديث ai_assistant/views.py لربط النقاط بالمستخدم الحالي
...
class AIChatView(APIView):
    ...
    def post(self, request):
        ...
        # ربط النقاط بالمستخدم الحالي المسجل أو الحساب الأول افتراضياً
...
# 6. تحديث settings.py لإضافة accounts
...
print("تم بناء وحدة الحسابات الحسابات وتحديث الإعدادات بنجاح!")
